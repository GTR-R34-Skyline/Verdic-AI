...
def submit():
    case_details = request.form.get('case_details')  # Get user input
...
def submit1():
    ...
    # Return a response
    return render_template('success.html', case_number=case_number)  # You can customize the response as needed
